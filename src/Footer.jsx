...
function Footer(props){
    ...
    return (<footer className='Footer'><a href="https://www.github.com/TroyWarez"><img className='githubIcon' src={gitHubIconSrc} width='48' height='48'/></a><p>{props.children}</p> <a></a><p>Copyleft © {currentDate.getFullYear()}</p></footer>);
}
Footer.propTypes = {
